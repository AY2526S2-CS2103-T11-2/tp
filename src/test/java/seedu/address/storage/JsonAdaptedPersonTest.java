...
public class JsonAdaptedPersonTest {
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(INVALID_NAME, VALID_AGE, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS, VALID_TAGS,
    ...
    public void toModelType_nullName_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(null, VALID_AGE, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS, VALID_TAGS,
                VALID_PARENT_NAME, VALID_PARENT_PHONE, VALID_PARENT_EMAIL);
    ...
    public void toModelType_invalidAge_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, INVALID_AGE, INVALID_PHONE, VALID_EMAIL, VALID_ADDRESS, VALID_TAGS,
                        VALID_PARENT_NAME, VALID_PARENT_PHONE, VALID_PARENT_EMAIL);
    ...
    public void toModelType_nullAge_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, null, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS, VALID_TAGS,
                VALID_PARENT_NAME, VALID_PARENT_PHONE, VALID_PARENT_EMAIL);
    ...
    public void toModelType_invalidPhone_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_AGE, INVALID_PHONE, VALID_EMAIL, VALID_ADDRESS, VALID_TAGS,
                        VALID_PARENT_NAME, VALID_PARENT_PHONE, VALID_PARENT_EMAIL);
    ...
    public void toModelType_nullPhone_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_AGE, null, VALID_EMAIL, VALID_ADDRESS, VALID_TAGS,
                VALID_PARENT_NAME, VALID_PARENT_PHONE, VALID_PARENT_EMAIL);
    ...
    public void toModelType_invalidEmail_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_AGE, VALID_PHONE, INVALID_EMAIL, VALID_ADDRESS, VALID_TAGS,
                        VALID_PARENT_NAME, VALID_PARENT_PHONE, VALID_PARENT_EMAIL);
    ...
    public void toModelType_invalidAddress_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_AGE, VALID_PHONE, VALID_EMAIL, INVALID_ADDRESS, VALID_TAGS,
                        VALID_PARENT_NAME, VALID_PARENT_PHONE, VALID_PARENT_EMAIL);
    ...
    public void toModelType_nullAddress_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_AGE, VALID_PHONE, VALID_EMAIL, null, VALID_TAGS,
                VALID_PARENT_NAME, VALID_PARENT_PHONE, VALID_PARENT_EMAIL);
    ...
    public void toModelType_invalidTags_throwsIllegalValueException() {
        ...
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_AGE, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS, invalidTags,
                        VALID_PARENT_NAME, VALID_PARENT_PHONE, VALID_PARENT_EMAIL);
    ...
    public void toModelType_nullParentName_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_AGE, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS, VALID_TAGS,
    ...
    public void toModelType_invalidParentName_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_AGE, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS, VALID_TAGS,
